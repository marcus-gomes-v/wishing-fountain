export default {
    translation: {
        ...
        header:{
            page_title_default: 'Register to #UnwrapYourDream this June!',
        ...
        components: {
            ...
            features: {
                icons: {
                    ...
                    three: {
                        name: 'HOW',
                        description: " Together, we can inspire children to harness their dreams and share them with others. Join us by registering for our campaign between the 1th of June"
